...
replace github.com/quenbyako/cynosure/contrib/tokencounter => ./contrib/tokencounter
...
require (
	...
	github.com/hashicorp/vault/api/auth/cert v0.0.0-20260519172043-bda5f042c5c7 // indirect
