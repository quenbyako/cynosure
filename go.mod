...
replace contrib/grpcutils => ./contrib/grpcutils

require (
	buf.build/gen/go/bufbuild/protovalidate/protocolbuffers/go v1.36.9-20250912141014-52f32327d4b0.1
	buf.build/go/protovalidate v1.0.0
	contrib/grpcutils v0.0.0-00010101000000-000000000000
	...
	github.com/hashicorp/vault/api/auth/cert v0.0.0-20250926190226-f1e073989126
