---
name: making-oauth-client
description: Use this skill, when you need to implement secure OAuth 2.0, OpenID Connect (OIDC), JWT authentication, and SSO integration. Use when building secure authentication systems for applications.
---
