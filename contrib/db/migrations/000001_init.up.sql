...
GRANT INSERT, DELETE, SELECT, UPDATE ON TABLE agents.mcp_tools TO cynosure;
GRANT INSERT, DELETE, SELECT, UPDATE ON TABLE agents.messages_user TO cynosure;
GRANT INSERT, DELETE, SELECT, UPDATE ON TABLE agents.messages TO cynosure;
GRANT INSERT, DELETE, SELECT, UPDATE ON TABLE agents.messages_tool_result TO cynosure;
GRANT INSERT, DELETE, SELECT, UPDATE ON TABLE agents.oauth_configs TO cynosure;
GRANT INSERT, DELETE, SELECT, UPDATE ON TABLE agents.mcp_accounts TO cynosure;
GRANT INSERT, DELETE, SELECT, UPDATE ON TABLE agents.oauth_tokens TO cynosure;
GRANT INSERT, DELETE, SELECT, UPDATE ON TABLE agents.agent_settings TO cynosure;
GRANT INSERT, DELETE, SELECT, UPDATE ON TABLE agents.messages_assistant TO cynosure;
GRANT INSERT, DELETE, SELECT, UPDATE ON TABLE agents.messages_tool_request TO cynosure;
