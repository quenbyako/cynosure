...
func RegisterWebhookServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server WebhookServiceServer) error {
	mux.Handle(http.MethodPost, pattern_WebhookService_SendUpdate_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/telegram.botapi.v9.WebhookService/SendUpdate", runtime.WithHTTPPathPattern("/"))
		if err != nil {
...
func RegisterWebhookServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client WebhookServiceClient) error {
	mux.Handle(http.MethodPost, pattern_WebhookService_SendUpdate_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		annotatedContext, err := runtime.AnnotateContext(ctx, mux, req, "/telegram.botapi.v9.WebhookService/SendUpdate", runtime.WithHTTPPathPattern("/"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	pattern_WebhookService_SendUpdate_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0}, []string{""}, ""))
)
